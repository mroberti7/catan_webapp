...
export const GameControllerApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async searchGames(
      ...
      sort?: Array<string>,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PageGameInfoDTO>> {
...
export const StatisticsControllerApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getGameDiceDashboard(
      gameId: number,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{ [key: string]: { [key: string]: number } }>> {
