...
const GameActions = ({ gameId, playerId, passTurn }: GameActionsProps) => {
  ...
  return (
    <div className="flex h-auto min-h-40 w-full flex-col items-center justify-center gap-5 p-8">
      <div className="grid grid-cols-4 place-items-end justify-items-center gap-2 md:grid-cols-7 md:gap-8">
        <Button
        ...
        >
          <div className="largestArmy flex size-8 items-center justify-center">{playerActions.knightCardPlayed ? '✅' : '❌'}</div>
          <div className="relative flex size-20 items-center justify-center">
        ...
        >
          <div className="largestArmy flex size-8 items-center justify-center">{playerActions.longestRoad ? '✅' : '❌'}</div>
          <div className="relative flex size-20 items-center justify-center">
            {/* <Image src={'/assets/icons/knight.png'} alt="road" fill /> */}
        ...
        >
          <div className="flex size-8 items-center justify-center">{playerActions.largestArmy ? '✅' : '❌'}</div>
          <div className="relative flex size-20 items-center justify-center">
            {/* <Image src={'/assets/icons/knight.png'} alt="road" fill /> */}
      ...
      <div className="flex gap-5">
        ...
        <Button onClick={cancelTurn} className="rounded-xl bg-primary p-3 text-catan-red hover:bg-opacity-80 md:p-4">
